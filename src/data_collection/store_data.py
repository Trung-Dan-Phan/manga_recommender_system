...
if __name__ == "__main__":
    ...
    write_data_to_bigquery(
        dataset_id="manga_dataset", table_id="manga_collection_raw", df=manga_data
    )
    write_data_to_bigquery(
        dataset_id="users_dataset", table_id="user_statistics_raw", df=user_statistics
    )
    write_data_to_bigquery(
        dataset_id="users_dataset", table_id="user_manga_list_raw", df=user_manga_list
    )
